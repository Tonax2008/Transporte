...
class Oficina(object):
    ...
    def setupUi(self, Form):
        ...
        self.tableWidget.setItem(0,1,QTableWidgetItem("TELEFONO"))
        self.tableWidget.setItem(0,2,QTableWidgetItem("ID EMAIL"))
        self.tableWidget.setItem(0,3,QTableWidgetItem("ID DIRECCION"))
        self.tableWidget.setItem(0,4,QTableWidgetItem("RAZ_SOC"))
    ...
    def update (self):
        ...
        for i in index:
            id_ofi=self.tableWidget.item(i,0).text()
            ...
            update=("UPDATE  OFICINA SET TELEFONO={},ID_COR={},ID_DIR={},RAZ_SOC='{}' WHERE ID_OFI={}".format(id_1,id_2,id_3,id_4, id_ofi))
            print(update)
    ...
    def Eliminar (self):
        ...
        for i in index:
            ...
            self.tableWidget.removeRow(i)
            delate="DELete FROM OFICINA WHERE ID_OFI={}".format(id_delate)
