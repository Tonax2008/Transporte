...
class Direcciones(object):
    ...
    def update (self):
        ...
        for i in index:
            id_DIR=self.tableWidget.item(i,0).text()
            ...
            update=("UPDATE  DIRECCION SET CALLE='{}',COLONIA='{}',CP={},DELEGACION='{}',NO_INT={},NO_EXT={},ID_EST={} WHERE ID_DIR={}".format(id_1,id_2,id_3,id_4,id_5,id_6,id_7, id_DIR))
            print(update)
    ...
    def Eliminar (self):
        ...
        for i in index:
            ...
            self.tableWidget.removeRow(i)
            delate="DELETE FROM DIRECCION WHERE ID_DIR={}".format(id_delate)
