 # Titulo a cada columna
        ...
        consulta= ('select  RAZ_SOC,DESCRIPCION , ID_VIA,MONTO,PLACA,NOMBRE FROM SERVICIO JOIN CLIENTE USING (ID_CLI) JOIN PAGO USING (ID_PAGO) JOIN EMPLEADO USING (ID_EMP) JOIN UNIDAD USING   (ID_UNI) ')
